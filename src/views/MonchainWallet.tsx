            ...
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-5xl mx-auto text-center mb-20 animate-fade-in-up">
                    ...
                    <p className="text-2xl text-foreground/70 leading-relaxed mb-8">
                        Secure your crypto assets with proactive fraud blocking (96% accuracy using the same core AI as
                        our enterprise API), and access AI-driven trading signals and market insights, all in one
                        intelligent, non-custodial wallet.
                    </p>
